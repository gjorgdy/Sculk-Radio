...
public class FzzyConfig extends Config {
    ...
    @Nullable
    private static Runnable configReload;
    ...
    public static void registerConfigReload(Runnable configReload) {
        FzzyConfig.configReload = configReload;
    }

    public static void reloadConfig() {
        if (FzzyConfig.configReload != null) {
            FzzyConfig.configReload.run();
        }
    }
